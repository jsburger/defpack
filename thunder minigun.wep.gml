#define init
global.sprThunderMinigun = sprite_add_weapon("sprites/sprThunderMinigun.png", 4, 4);
#define weapon_name
return "THUNDER MINIGUN";

#define weapon_sprt
return global.sprThunderMinigun;
...
repeat(2)
{
	...
	with mod_script_call("mod", "defpack tools", "create_lightning_bullet",x,y){
		...
		motion_add(other.gunangle+random_range(-12,12)*other.accuracy,8)
