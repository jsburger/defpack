...
with mod_script_call("mod", "defpack tools", "create_fire_bullet",x+lengthdir_x(8,gunangle),y+lengthdir_y(8,gunangle))
{
		...
		do
		{
			...
			if random(9) < 1*current_time_scale {with instance_create(x,y,Flame){team = other.team;creator = other.creator;motion_add(random(359),random_range(2,4))}}
