...
#define weapon_fire
weapon_post(7,-13,7)
sound_play_pitchvol(sndBloodCannon,1.3+random(.1),.5)
...
var i = -1
repeat(2){
    with lightning_create(_x,_y,12,other.gunangle + random_range(15,45) * i){
        team = other.team
        creator = other
        alarm0 = 1
        forks = 2
...
#define lightning_grow()
    ...
    if(--ammo > 0){
        ...
        if !irandom(10) with instance_create(x,y,BloodStreak){
