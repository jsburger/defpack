#define init
global.sprFrogMilk = sprite_add_weapon("../sprites/weapons/sprFrogMilk.png",-2,1)
...
return -1
#define soda_avail
return (array_length(instances_matching(Player, "notoxic", 0)) > 0)
#define weapon_load
return 0
#define weapon_swap
...
#define weapon_text
return choose("A VALUABLE SOURCE OF @gFROG MINERALS@s", "TASTES LIKE AN AIR FRESHNER")
