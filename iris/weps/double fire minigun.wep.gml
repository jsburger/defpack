#define init
global.sprDoubleFireMinigun    = sprite_add_weapon("sprites/sprDoubleFireMinigun.png", 10, 2);
global.sprDoubleFireMinigunHUD = sprite_add_weapon("sprites/sprDoubleFireMinigun.png", 14, 7);
