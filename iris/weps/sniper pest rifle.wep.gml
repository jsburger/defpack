...
global.sprPestMuzzle 	  	= sprite_add("sprites/projectiles/sprPestMuzzle.png", 1, 7, 7)
global.sprToxicBulletHit  = sprite_add("sprites/projectiles/sprPestBulletHit.png", 4, 8, 8)
#define weapon_name
...
if button_check(index, btn) = false || holdtime <= 0
{
	...
	with creator
	{
		...
		with instance_create(x,y,CustomProjectile)
		{
			...
			depth = -1
			sprite_index = global.sprPestMuzzle
			mask_index   = mskNone
			image_speed = .4
