...
global.sprFireMuzzle			= sprite_add("sprites/projectiles/sprFireMuzzle.png", 1, 7, 7);
global.sprFireBulletHit   = sprite_add("sprites/projectiles/sprFireBulletHit.png", 4, 8, 8);
...
if button_check(index, btn) = false || holdtime <= 0
{
	...
	with creator
	{
		...
		with instance_create(x,y,CustomProjectile)
		{
			...
			depth = -1
			sprite_index = global.sprFireMuzzle
			mask_index   = mskNone
			image_speed = .4
