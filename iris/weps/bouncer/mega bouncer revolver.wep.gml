#define init
global.sprMegaBouncerRevolver   = sprite_add_weapon("sprites/sprMegaBouncerRevolver.png", -1, 3);
global.sprMegaBouncerBullet     = sprite_add("sprites/projectiles/sprMegaBouncerBullet.png",2,18,18)
