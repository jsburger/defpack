#define init
global.sprBouncerGunhammer 		= sprite_add_weapon("sprites/sprBouncerGunhammer.png", 2, 10);
global.sprBouncerGunhammerHUD = sprite_add_weapon("sprites/sprBouncerGunhammer.png", 8, 6);
