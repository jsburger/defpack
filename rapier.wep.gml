...
if rapiers != 1{
  ...
  var _e = 24 + 12 * skill_get(mut_long_arms);
	...
	with instance_create(x+lengthdir_x(_e / 40,gunangle),y+lengthdir_y(_e / 40,gunangle), CustomObject){
...
#define fx_step
if ((image_index + image_speed) >= (sprite_get_number(sprite_index) - .1)) || !place_meeting(x, y, Floor){
	instance_destroy()
}
