#define init
  global.sprBullet = sprite_add_weapon("../../../sprites/sage/bullets/sprBulletRust.png", 7, 7);
  global.sprFairy = sprite_add("../../../sprites/sage/bullet icons/sprFairyIconRust.png", 0, 5, 5);
