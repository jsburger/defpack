#define init
global.sprUltraGunhammer = sprite_add_weapon("sprites/Ultra Gunhammer.png", 0, 9);
global.sprUltraGunhammerOff = sprite_add_weapon("sprites/Ultra Gunhammer Off.png", 6, 5);
