#define init
global.sprSmartBazooka 		   = sprite_add_weapon("../sprites/weapons/sprSmartBazooka.png", 14, 4);
global.sprBlueExplosion 		 = sprExplosion//sprite_add("../sprites/projectiles/Blue Explosion_strip9.png",9,24,24)
