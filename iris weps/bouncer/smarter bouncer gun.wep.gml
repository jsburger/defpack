#define init
global.sprSmarterGun 	  = sprite_add_weapon("../../sprites/weapons/iris/bouncer/sprSmarterBouncerGun.png",9,8)
global.sprSmarterGunHUD = sprite_add_weapon("../../sprites/weapons/iris/bouncer/sprSmarterBouncerGun.png",1,4)
#define weapon_name
...
if _canshoot{
    ...
    sound_play_pitchvol(sndBouncerSmg, 1.3 * _r, _v*.7)
