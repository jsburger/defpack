#define init
global.sprPsyGunhammer 		 = sprite_add_weapon("../../sprites/weapons/iris/psy/sprPsyGunhammer.png", 2, 11);
global.sprPsyGunhammerHUD  = sprite_add_weapon("../../sprites/weapons/iris/psy/sprPsyGunhammer.png", 11, 5);
