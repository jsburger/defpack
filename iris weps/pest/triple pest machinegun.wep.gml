#define init
global.sprTriplePestMachinegun = sprite_add_weapon("../../sprites/weapons/iris/pest/sprTriplePestMachinegun.png", 4, 5);
#define weapon_name
...
with mod_script_call("mod", "defpack tools", "create_toxic_bullet",x,y){
    ...
    motion_set(other.gunangle + 20 * other.accuracy + random_range(-2,2) * other.accuracy,16)
