#define init
global.sprGoldenPestPistol = sprite_add_weapon("../../sprites/weapons/iris/pest/sprGoldenPestRevolver.png", -3, 2);
...
sound_play_pitchvol(sndGoldPistol,random_range(.6,.8), vol)
