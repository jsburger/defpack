#define init
global.sprGoldenThunderMachinegun = sprite_add_weapon("../../sprites/weapons/iris/thunder/sprGoldenThunderMachinegun.png", 4, 2);
#define weapon_name
return "GOLDEN THUNDER MACHINEGUN";

#define weapon_sprt
return global.sprGoldenThunderMachinegun;
...
repeat(2)
{
	...
	sound_play_pitchvol(sndGoldMachinegun, 1, vol)
	if !skill_get(17)
