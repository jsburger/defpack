...
repeat(2)
{
  ...
  var vol = .6;
  sound_play_pitchvol(sndSawedOffShotgun,.7*_p, vol)
  sound_play_pitchvol(sndLightningCannon,.6*_p, vol)
  sound_play_pitchvol(sndLightningCannonEnd,.5*_p, vol)
  sound_play_pitchvol(sndGammaGutsKill,.5*_p*_s, vol)
  sound_play_pitchvol(sndLightningRifleUpg,.7*_s*_p, vol)
